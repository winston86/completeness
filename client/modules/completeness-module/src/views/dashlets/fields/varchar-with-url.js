...
Espo.define('completeness-module:views/dashlets/fields/varchar-with-url', 'views/fields/varchar',
    Dep => Dep.extend({

        listTemplate: 'completeness-module:dashlets/fields/varchar-with-url/list',
