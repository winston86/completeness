...
Espo.define('completeness-module:views/dashlets/fields/colored-varchar-with-url', 'completeness-module:views/dashlets/fields/varchar-with-url',
    Dep => Dep.extend({

        listTemplate: 'completeness-module:dashlets/fields/colored-varchar-with-url/list',
