...
Espo.define('completeness:views/dashlets/fields/colored-varchar-with-url', 'completeness:views/dashlets/fields/varchar-with-url',
    Dep => Dep.extend({

        listTemplate: 'completeness:dashlets/fields/colored-varchar-with-url/list',
