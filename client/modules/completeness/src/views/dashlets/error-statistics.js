...
Espo.define('completeness:views/dashlets/error-statistics', 'views/dashlets/abstract/base',
    Dep => Dep.extend({
                ...
                this.listenToOnce(collection, 'sync', function () {
                    this.createView('list', 'views/record/list', {
                        ...
                        listLayout: [
                            {
                                name: 'name',
                                view: 'completeness:views/dashlets/fields/varchar-with-url',
                                notSortable: true,
                                width: '80'
                            },
                            {
                                name: 'amount',
                                view: 'completeness:views/dashlets/fields/percent-varchar',
                                notSortable: true,
                                width: '20'
                            }
                        ]
